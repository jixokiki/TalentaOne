...
export default function NavbarWorker() {
  ...
  const handleProfileClick = () => {
    router.push('/profileWorker'); // Arahkan ke halaman profile worker
  };
            ...
            >
              ...
              <div className="px-4 sm:px-6 py-4">
                <div className="grid sm:grid-cols-2 gap-3">
                  {/* Links block (elemen <a> tetap) */}
                  <nav className="space-y-1">
                    {[
                      { href: '/dashboard-worker', label: 'Home' },
                      { href: '#', label: 'About' },
                      { href: '/dashboard-worker/services', label: 'Services' },
                      { href: '#', label: 'Contact' },
                    ].map((item, i) => (
                      <motion.a
                        key={item.href}
